...
```{r spagetti plot}
victims_incidents %>%
  filter(state %in% c("Alabama", "Arkansas", "Florida", "Georgia", "Louisiana", "Mississipi", "North Carolina", "South Carolina", "Tennessee", "Texas", "Virginia"))
...
victims_incidents %>%
  ggplot( aes(x=year, y=n, group=state, color=state)) +
    ...
    ggtitle("Incident Count By State and Year") +
    theme_ipsum()
```
...
>>>>>>> f7ba748557d71faaae1b75237eaf5f20f8182693
